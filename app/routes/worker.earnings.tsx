            ...
            {loading ? (
               ...
               <div className="space-y-3 lg:space-y-4">
                 {apps.map(app => {
                    ...
                    return (
                      <div key={app.id} className="bg-white rounded-2xl p-5 shadow-sm border border-slate-100 flex items-center justify-between hover:shadow-md hover:border-blue-100 transition-all cursor-default animate-in fade-in duration-300">

...
const FAQ_CATEGORIES: { category: string; faqs: { q: string; a: string }[] }[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "Do I need ID verification to apply?", a: "No. You can apply to gigs and internships as soon as you sign up. Verification is optional, but it puts a badge on your profile and hirers pick verified workers first, so it's worth doing early." },

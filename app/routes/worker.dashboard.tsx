        ...
        <div className="w-full lg:grid lg:grid-cols-2 xl:grid-cols-3 lg:gap-6">
          {loading ? (
            ...
            <div className="bg-[#1C1C1C] rounded-2xl p-8 lg:p-12 text-center shadow-sm border border-white/5 flex flex-col items-center mt-2 col-span-full">
               ...
               {tab === 'active' && (
                 <button onClick={() => navigate('/worker/home')} className="mt-8 px-8 py-3.5 min-h-[44px] bg-[#F4511E] text-white text-sm font-black tracking-wide rounded-xl shadow-lg hover:bg-[#D84315] transition-colors btn-tap">
                   Browse Live Gigs
                 </button>
               )}
            </div>
                   ...
                   >
                     <div className="flex justify-between items-start mb-5">
                        <div className="flex pr-4">
                          <img src={getImageUrl(app.gig.role_type)} alt={app.gig.role_type} loading="lazy" decoding="async" className="w-12 h-12 rounded-xl object-cover mr-4" />
                          <div>
